...
<head>
    ...
    <link rel="stylesheet" href="Css/styleColecao2.css">
    <style>
/* SCROLL DO MOUSE */
::-webkit-scrollbar {
    ...
    <main>
        <section class="collections">
            <div class="collection-item">
                <img src="imagens/colecoes/1ASAP.svg" alt="Coleção Don't Be Dumb">
                <h2>DON'T BE DUMB COL.</h2>
                <p>07/11/24</p>
                
            </div>
            <p class="textoextra">Entre em contato para saber mais</p>
        </section>
    </main>
